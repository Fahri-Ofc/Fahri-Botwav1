...
petik = '```'
fake = '© ℭ𝔯𝔢𝔞𝔱𝔬𝔯 Fahri Ganz'//GANTI NAMA KAMU BEP
ban =[]
...
module.exports = dha = async (dha, mek) => {
	try {
        ...
        const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
            let po = dha.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "Pilih Disini","footerText": "© ℭ𝔯𝔢𝔞𝔱𝔬𝔯 Fahri Ganz","listType": "SINGLE_SELECT","sections": list}}, {})
     ...
     const time2 = moment().tz('Asia/Jakarta').format('HH:mm:ss')
       ...
       console.error(err)
        ...
        const ftoko = {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: {"productMessage": {"product": {"productImage":{"mimetype": "image/jpeg","jpegThumbnail": fs.readFileSync(`./media/sherlynn.jpg`)},"title": `© Fahri BOT`,"description": "ℭ𝔯𝔢𝔞𝔱𝔬𝔯 Fahri Ganz", "currencyCode": "IDR","priceAmount1000": "999999","retailerId": "Fahri BOT","productImageCount": 1},"businessOwnerJid": `0@s.whatsapp.net`}}}
...
*Sewa bot?* Chat wa.me/6285157740529`
               ...
               buttonsMessage = {
               contentText: `${menu}`,
               footerText: '© ℭ𝔯𝔢𝔞𝔱𝔬𝔯 Fahri Ganz', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
*Cek list Server GTIVD dibawah!*`
       ...
       case 'othercmd':
               ...
               startnum = 0
               for (let x of listmenu) {
               const yy = {title: '© ℭ𝔯𝔢𝔞𝔱𝔬𝔯 Fahri Ganz ' + nombor++,
                    rows: [
                       {
                        title: `${listmenuu[startnum++]}`,
                        description: ``,
       ...
       case 'store':
               ...
               listmsg(from, `${ucapanWaktu}`,   `© ℭ𝔯𝔢𝔞𝔱𝔬𝔯 Fahri Ganz`, list)
               break
//------------------< Game >------------------- 
        case 'limitgame': 
        case 'balance': 
...
//------------------< Premium >-------------------
       ...
       case 'sewabot':
              ...
              teksnya = `*[ PRICE LIST ]*
*Sewa Fahri BOT ON 24 Jam(Jika Tidak Ada Hambatan)*
*1 Hari :* 1K
*1 Minggu :* 5K
*1 Bulan :* 10K
...
case 'tiktok':
              ...
              imageMsg = (await dha.prepareMessageMedia(fs.readFileSync(`./media/sherlynn.jpg`), 'imageMessage', {thumbnail: fs.readFileSync(`./media/sherlynn.jpg`)})).imageMessage
              buttonsMessage = {footerText:'Jangan Lupa Subscribe Yt Fahri BOT\n Helpme tu 1k subscriber', imageMessage: imageMsg,
       ...
       case 'img2url':
         ...
         case 'asupan': // shansekai                
              ...
              .then(async (body) => {
               ...
               sendMediaURL(from, `http://sansekai.my.id/ptl_repost/${asupanx}`, '\`\`\`ASUPAN BRO GUA DAPAT DARI Fahri BOT\`\`\`')
...
dha.sendMessage(from, tapib1, document, { quoted: mek, filename:`Fahri BOT ~ 404 ${vipi}.mp3`, mimetype: 'audio/application' })
...
dha.sendMessage(_.jid, 
			{"contentText": `*「 Siaran Fahri BOT 」*\n© Fahri BOT\n*Isi Pesan :* ${body.slice(4)}`,
			"footerText": '© ℭ𝔯𝔢𝔞𝔱𝔬𝔯 Fahri Ganz',
			"buttons": [
...
//------------------< Menunya Bang:v >-------------------
      ...
      case 'infoig':
             ...
             break
      case 'grupbot':
             reply('https://chat.whatsapp.com/BeJH7mw5pM5H8siiYyuqaO')
             break
      case 'ownermenu':
